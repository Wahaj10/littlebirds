        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-4">
              {["About", "Fun Stuff", "Happy Parents", "Say Hi!"].map(
                (item, index) => (
                  <li key={index}>
                    <Link
      ...
      <main className="flex-grow">
        <section className="py-20 relative overflow-hidden">
          <div className="container mx-auto text-center relative z-10">
            <h1 className="text-5xl font-bold mb-4 text-blue-900 animate-bounce">
              Welcome to Our Nest of Fun!
            </h1>
            <p className="text-2xl mb-8 text-blue-700">
              Where Little Birds Spread Their Wings and Soar!
            </p>
            <Button
              asChild
              className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-3 px-6 rounded-full text-xl animate-pulse"
            >
        ...
        <section
          id="about"
          className="py-16 bg-blue-100 rounded-3xl mx-4 my-8 shadow-inner"
        >
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-center text-blue-900">
              Our Silly Philosophy
            </h2>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4 text-lg text-blue-800">
                <p>
                  At Little Birds Day Home, we believe in giggles, wiggles, and
                  learning through play! Our nest is where:
                </p>
                ...
                <p>
                  We&apos;re not just a daycare, we&apos;re a launchpad for
                  little explorers, dreamers, and future world-changers!
                </p>
              </div>
              ...
              {[
                {
                  ...
                  description:
                    "A cozy spot for our littlest birds to chirp, crawl, and make new friends!",
                  icon: "🏡",
                },
                {
                  ...
                  age: "3 - 5 years",
                  description:
                    "Where ABCs and 123s meet dress-up and make-believe!",
                  icon: "🎉",
                },
                {
                  ...
                  age: "5 - 12 years",
                  description:
                    "Homework help meets epic quests and cool experiments!",
                  icon: "🚀",
                },
              ].map((program, index) => (
                <Card
                  key={index}
                  className="bg-yellow-100 rounded-3xl shadow-lg overflow-hidden transform transition-all hover:scale-105"
                >
        ...
        <section
          id="happy-parents"
          className="py-16 bg-pink-100 rounded-3xl mx-4 my-8 shadow-inner"
        >
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-center text-blue-900">
              Happy Bird Families
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                {
                  quote:
                    "Little Birds is like a second nest for our little chick! She comes home every day with new songs and funny stories!",
                  author: "Mama Robin",
                },
                {
                  quote:
                    "Our son used to be shy, but now he's the leader of his own pirate crew! Thank you for helping him find his voice!",
                  author: "Papa Sparrow",
                },
                ...
                >
                  <CardContent className="p-6">
                    <p className="mb-4 italic text-lg text-blue-700">
                      &quot;{testimonial.quote}&quot;
                    </p>
        ...
        <section
          id="say-hi"
          className="py-16 bg-green-100 rounded-3xl mx-4 my-8 shadow-inner"
        >
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-center text-blue-900">
              Let&apos;s Chat!
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-blue-800">
                  Send Us a Friendly Chirp
                </h3>
                <form className="space-y-4">
                  <Input
                    type="text"
                    placeholder="Your Name (Superhero names welcome!)"
                    className="rounded-full"
                  />
                  <Input
                    type="email"
                    placeholder="Your Email (No owl post, sorry!)"
                    className="rounded-full"
                  />
                  <Input
                    type="tel"
                    placeholder="Your Phone (For important playtime updates)"
                    className="rounded-full"
                  />
                  <Textarea
                    placeholder="Your Message (Tell us your favorite joke!)"
                    className="rounded-2xl"
                  />
                  <Button
                    type="submit"
                    className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold py-2 px-4 rounded-full w-full"
                  >
                    Send Your Chirp!
                  </Button>
                </form>
      ...
      <footer className="bg-yellow-400 py-8 rounded-t-3xl shadow-inner">
        <div className="container mx-auto text-center">
          <p className="text-blue-900 text-lg">
            ...
            reserved (but fun is always free!)
          </p>
          <p className="mt-2 text-blue-700">
            <Link href="/privacy" className="hover:underline">
              Our Promise to Keep Secrets
            </Link>{" "}
            |
